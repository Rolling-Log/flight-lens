...
初次真实检索记录时间：2026-07-31 15:52 CST；本轮候选复核时间：2026-08-04 12:01 CST。

- Git 运行时候选提交：`ccfa69e`（包含附近始发机场执行、双输入一致性、Netlify 同域 API、有界搜索运行时与免费额度防滥用修复）；
- Netlify 项目：`flight-lens-staging`，当前候选 Deploy：`6a71632f5c70d7f3ebc81d5e`；
